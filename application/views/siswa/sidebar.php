	...
	<div class="sidebar-nav slimscrollsidebar">
		<div class="sidebar-head">
			...
			<ul class="nav" id="side-menu">
				...
				<li> <a href="<?= base_url('Siswa/datanilai') ?>" class="m-l-10"><i class="fa fa-dashboard fa-fw" data-icon="v"></i> Data Nilai</a> </li>
				<li> <a href="<?= base_url('Siswa/datamapel') ?>" class="m-l-10"><i class="fa fa-dashboard fa-fw" data-icon="v"></i> Data Mapel</a> </li>
