...
class siswa_models extends CI_Model
{
	...
	{
		return $this->db->query('select nama_mapel,nilai,grade,keterangan,catatan from tbl_siswa join tbl_nilai on tbl_siswa.nis=tbl_nilai.nis join tbl_mata_pelajaran on tbl_nilai.id_mapel=tbl_mata_pelajaran.id_mapel where tbl_siswa.nis="'.$nis.'" and tbl_nilai.kls="'.$kls.'"')->result_array();
	} 
